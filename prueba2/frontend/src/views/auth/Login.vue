...
async function onSubmit() {
  ...
  try {
    ...
    router.replace(route.query.redirect || { name: 'calendario' });
  } catch (err) {
  ...
  <div class="min-h-screen w-full flex items-center justify-center bg-club-green
    ...
    <div class="w-full max-w-sm">
      ...
      <div class="flex flex-col items-center mb-8">
        <img src="/escudo.svg" alt="Escudo Atlético Palma del Río" class="w-28 h-auto drop-shadow-lg" />
        <h1 class="mt-4 font-display text-2xl text-club-cream tracking-wide text-center">
