...
import { partidosService, categoriasService, lugaresService } from '../../services';
...
const emptyItem = { id_categoria: null, fecha: null, id_lugar: null, equipo_rival: '', incidencias: '' };
